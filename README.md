...
*A similar lightweight and fast tool [onex](https://github.com/penta7777/onex) is available. We can use onex instead of Tool-X*
...
* `git clone https://github.com/penta7777/Tool-X.git`
