...
*A similar lightweight and fast tool [onex](https://github.com/onata2013/onex) is available. We can use onex instead of Tool-X*
...
* `git clone https://github.com/onata2013/Tool-X.git`
